...
class PlatformDeployer:
    """Perform the initial deployment to NewFly
    ...
    def deploy(self, *args, **options):
        ...
        plugin_utils.write_output("\nConfiguring project for deployment to NewFly...")

        self._validate_platform()
        self._prep_automate_all()

        # Configure project for deployment to NewFly
    ...
    def _validate_platform(self):
        """Make sure the local environment and project supports deployment to NewFly.
    ...
    def _conclude_automate_all(self):
        """Finish automating the push to NewFly.
        ...
        # Push project.
        plugin_utils.write_output("  Deploying to NewFly...")
